...
<main>
  <div class="uk-container">
    <h1 class="uk-heading-small uk-heading-divider">Bitcoin Price History</h1>
    ...
    >
      <thead>
        <tr>
          ...
          <th class="uk-width-1-6">Price (US$)</th>
          <th class="uk-width-1-6">Change (US$)</th>
      ...
      <tbody>
        {#each quotes as quote, i}
          <tr
            class="uk-text-left"
            class:uk-active={quote_clicked === i}
            on:click={() => {
              handleRowClick(i);
            }}
          >
